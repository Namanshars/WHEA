...
public class GetData {
    public static void main(String[] args) {
        String urlString =
                String.format("http://api.worldbank.org/v2/country/%s/indicator/SP.POP.TOTL?date=2000:2001&format=json", "can");
            ...
            if (responsecode == 200) {
                ...
                for (int i = 0; i < sizeOfResults; i++) {
                    ...
                    if(jsonArray.get(1).getAsJsonArray().get(i).getAsJsonObject(
                        ...
                        // “value” FIELD
                        populationForYear =
                                jsonArray.get(1).getAsJsonArray().get(i).getAsJsonObject().get("value").getAsInt();

                    System.out.println("Population for : " + year + " is " +
                            populationForYear);
                    cummulativePopulation =
                            cummulativePopulation + populationForYear;
                }
